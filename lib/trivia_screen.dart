...
import 'package:imersao_cubos_academy_app/question.dart';
import 'package:imersao_cubos_academy_app/score_screen.dart';
...
class _TriviaScreenState extends State<TriviaScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          automaticallyImplyLeading: false, //remover o botão voltar
            ...
            Container(
              ...
              child: Center(
                child: FlatButton(
                    ...
                    child: Text("Responder", style: TextStyle(fontSize: 16),),
